...
# 从环境变量中读取配置（由 HA run.sh 启动层注入，回退为用户当前看板参数）
RTSP_URL = os.getenv("RTSP_URL", "rtsp://192.168.1.100:554/live/main")
RECONNECT_INTERVAL = int(os.getenv("RECONNECT_INTERVAL", "5"))
MQTT_HOST = os.getenv("MQTT_HOST", "192.168.1.5")
MQTT_PORT = int(os.getenv("MQTT_PORT", "1883"))
MQTT_USER = os.getenv("MQTT_USERNAME", "homeassistant")
MQTT_PASS = os.getenv("MQTT_PASSWORD", "secure_password")
MQTT_TOPIC = os.getenv("MQTT_TOPIC", "homeassistant/sensor/hand_gesture/state")
SENSOR_NAME = os.getenv("SENSOR_NAME", "手势识别传感器")
